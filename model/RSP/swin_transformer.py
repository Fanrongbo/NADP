...
class swin(nn.Module):
    ...
    def init_weights(self):
        ...
        if self.args.mode == 'imp':
            pretrained = '../pretrain_model/swin_tiny_patch4_window7_224.pth'
        elif self.args.mode == 'rsp_120':
            ...
            pretrained ='/data/project_frb/SegDA/Segonly/model/RSP/pretrain/rsp-swin-t-ckpt.pth'
        else:
...
#            print(state_dict.keys())
    ...
    #     self._freeze_stages()
        ...
        #         # trick: eval have effect on LayerNorm only
        #         if isinstance(m, _LazyNormBase):
        #             m.eval()
