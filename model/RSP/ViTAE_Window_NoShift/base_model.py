...
class ViTAE_Window_NoShift_basic(nn.Module):
    def __init__(self, args, img_size=224, in_chans=3, stages=4, embed_dims=64, token_dims=64, downsample_ratios=[4, 2, 2, 2], kernel_size=[7, 3, 3, 3], 
    ...
    def init_weights(self, pretrained=None):
        ...
        if self.args.mode == 'imp':
            ...
            pretrained='/data/project_frb/SegDA/Segonly/model/RSP/pretrain/rsp-vitaev2-s-ckpt.pth'
        else:
