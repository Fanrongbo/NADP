...
from model.deeplabv3plusPrototypeShow import DeepLabV3PlusSimGlobalLinearKL3,SemanticSegmentationVarianceLoss,SemanticSegmentationCosineLoss
...
if __name__ == '__main__':
    ...
    name = opt.dset + '-zNewWeightCos/' + opt.model_type + '-test'
    opt.LChannel = False
    ...
    if opt.dset == 'mmlab':
        ...
        # cfg.TRAINLOG.DATA_NAMES = ['vailhingen6Full3', 'potsdamRGB6']
    ...
    if opt.load_pretrain:
        ...
        # saveroot = '/data/project_frb/SegDA/AttenDA2/zmain/log/mmlab-zNewWeightCos/deeplabv3-OriginalBaseNewP/20240615-18_13_po-va-OriNoWeight-11-2DGAN-noent-CE-Max-Cos-ST1pNewBestDP/'
        # save_path = saveroot + '/savemodel/_21_acc-0.9246_miou-0.8398_mf1-0.9120.pth'
        # saveroot = '/data/project_frb/SegDA/AttenDA2/zmain/log/mmlab-zNewWeightCos/deeplabv3-step2/20240615-19_40_po-va-OriNoWeight-11-2DGAN-noent-CE-Max-Cos-ST111222pNewBestDPBest/'
        # save_path = saveroot + '/savemodel/_31_acc-0.9284_miou-0.8511_mf1-0.9187.pth'
        # saveroot = '/data/project_frb/SegDA/AttenDA2/zmain/log/mmlab-zNewWeightCos/deeplabv3-step1/20240615-18_13_po-va-OriNoWeight-11-2DGAN-noent-CE-Max-Cos-ST1pNewBestDP/'
        # save_path = saveroot + '/savemodel/_31_acc-0.9337_miou-0.8561_mf1-0.9217.pth'
        # saveroot = '/data/project_frb/SegDA/AttenDA2/zmain/log/mmlab-zNewWeightCos/deeplabv3-step1/20240619-20_25_po-va-OriNoWeight-11-2DGAN-noent-CE-Max-Cos-ST1pNewBestDP/'
        # save_path = saveroot + '/savemodel/_31_acc-0.9191_miou-0.8077_mf1-0.8907.pth'
        # saveroot = '/data/project_frb/SegDA/AttenDA2/zmain/log/mmlab-zNewWeightCos/deeplabv3-step1/20240620-01_15_po-va-OriNoWeight-11-2DGAN-noent-CE-Max-Cos-ST1pNewBestDP-3GAN/'
        # save_path = saveroot + '/savemodel/_18_acc-0.8868_miou-0.7803_mf1-0.8750.pth'
        # saveroot = '/data/project_frb/SegDA/AttenDA2/zmain/log/mmlab-zNewWeightCos/deeplabv3-step1/20240621-14_57_va-po-OriNoWeight-11-2DGAN-noent-CE-Max-Cos-ST1pNewBestDP/'
        # save_path = saveroot + '/savemodel/_21_acc-0.9187_miou-0.7901_mf1-0.8734.pth'
        # saveroot = '/data/project_frb/SegDA/AttenDA2/zmain/log/mmlab-zNewWeightCos/deeplabv3-step1/20240622-00_53_va-po-OriNoWeight-11-2DGAN-noent-CE-Max-Cos-ST1pNewBestDP/'
        # save_path = saveroot + '/savemodel/_31_acc-0.9483_miou-0.8542_mf1-0.9170.pth'
        # saveroot = '/data/project_frb/SegDA/AttenDA2/zmain/log/mmlab-zNewWeightCos/deeplabv3-step1/20240622-15_14_po-va-OriNoWeight-11-2DGAN-noent-CE-Max-Cos-ST1pNewBestDPIR/'
        # save_path = saveroot + '/savemodel/_27_acc-0.9410_miou-0.8642_mf1-0.9261.pth'
        # saveroot = '/data/project_frb/SegDA/AttenDA2/zmain/log/mmlab-zNewWeightCos/deeplabv3-step1/20240623-13_40_po-va-OriNoWeight-11-2DGAN-noent-CE-Max-Cos-ST1pNewBestDPIR-2GAN/'
        # save_path = saveroot + '/savemodel/_29_acc-0.9442_miou-0.8707_mf1-0.9299.pth'
        saveroot = '/datab/frb-project/AttenDA2/zmain/log/mmlab-zNewWeightCos/deeplabv3-step1/20240627-15_26_po-va-OriNoWeight-11-2DGAN-noent-CE-Max-Cos-ST1pNewBestDP111111/'
        save_path = saveroot + '/savemodel/_29_acc-0.9338_miou-0.8518_mf1-0.9190.pth'
    else:
        saveroot = None
        save_path = None
    ...
    time_now = time.strftime(
        ...
        '-OriNoWeight-11-2DGAN-noent-CE-Max-Cos-ST333311pNewBestDP',
        time.localtime())
    ...
    n_cluster=1
    netStudent = DeepLabV3PlusSimGlobalLinearKL3(num_classes=6, args=opt2,n_cluster=n_cluster).to(DEVICE)
    ...
    GetIntCentriod_source=GetIntCentriodDPST(opt=opt,dataloaderS=train_loader,dataloaderT=t_loader,
                                           device=DEVICE,Osize=outFeatSize,n_cluster=[3,3,3,3,1,1])
    ########Val Set
    ...
    for epoch in range(22, opt.num_epochs + opt.num_decay_epochs + 1):
        #
        if epoch<5:
            ...
            PrototypeScat = GetIntCentriod_source.getClusterKmean(model=netStudent, iterFlag=ttest, STFlag=True,confidence_threshold=1.0-(epoch)*0.01)
            print('PrototypeScat', PrototypeScat.shape)
        ...
        for i in tbar:
            ...
            # print('PC',PS['CurrentPorotype'].shape)
            # varloss=varLoss(PS['CurrentPorotype'])
            # distloss=distLoss(FeatS['asspF'],labelsP)

            # print('varloss',varloss,distloss)
            ...
            loss_GT = 0.001 * bce_loss(D_out1,
                      ...
                      0.001*0.5 * (bce_loss(D_out2_S,
                                       ...
                                       Variable(torch.FloatTensor(D_out2_T.data.size()).fill_(source_label)).to(
                                           DEVICE)))
            (SCELoss + loss_GT + SCELossP).backward()
            # optimizer.step()
            # optimizer_D1.step()
            # optimizer_D2.step()
            # optimizer.zero_grad()
